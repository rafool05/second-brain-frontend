...
export function BrainIcon(props : iconInterface){
    const classes = iconStyleSize[props.size] + iconVarStyles[props.variant]
    return <svg className={classes} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
