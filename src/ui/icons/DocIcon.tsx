...
export const DocIcon = (props : iconInterface) =>{
        const classes = iconStyleSize[props.size] + iconVarStyles[props.variant]
    
    return <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" className = {classes}>
